...
@section('content')
    <div id="kt_app_content_container" class="app-container  container-xxl ">
        <!--begin::Form-->
        <form id="approvalForm" class="form d-flex flex-column flex-lg-row" action="{{ route('customer.rental.update') }}" method="POST">
            @csrf
            @method('PATCH')
                            ...
                            <table class="table align-middle table-row-dashed fs-6 gy-5"
                                ...
                                <tbody class="fw-semibold text-gray-600">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <input id="dataTableProductQuantity" type="number" oninput="collectProduct(this, {{ json_encode($product) }}, {{ $number_of_days }})" min="0" max="{{ $product->stock }}" class="form-control form-control-sm form-control-solid" title="Requeted amount is not available for this date!" value="{{ $requested_quantity }}"/>
                                        </td>
                                    </tr>
                                    @endforeach
                                </tbody>
                                        ...
                                        <tfoot id="product_footer">
                                            ...
                                            <tr class="d-none">
                                                ...
                                                <td class="text-end" id="discountRow">
                                                    <input id="discountInput" oninput="calculateGrandTotal()" class="form-control form-control-sm" type="number" min="0" name="discount" value="{{ $invoice->discount }}" readonly>
                                                </td>
                                            </tr>
                                            <tr class="d-none">
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-end" id="paidRow">
                                                    <input id="paidInput" oninput="calculateGrandTotal()" class="form-control form-control-sm" type="number" min="0" name="paid" value="{{ $invoice->paid }}" readonly>
                                                </td>
                                            </tr>
                                            <td colspan="3" class="border-top border-gray-200 text-end">Due (TK)</td>
                                            <td class="text-end" id="dueRow">{{ $invoice->due }}
                                                <input id="dueInput" class="form-control form-control-sm" type="hidden" min="0" name="due" value="{{ $invoice->due }}" readonly>
                                            </td>
                                        </tfoot>
                                    </table>
                                </div>
...
@section('exclusive_scripts')
    ...
    <script>
        ...
        //handle approve or decline button
        document.addEventListener('DOMContentLoaded', function () {
            ...
            approveButton.addEventListener('click', function (e) {
                ...
                approvalForm.action = "{{ route('customer.rental.update') }}";
