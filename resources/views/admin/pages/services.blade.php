                    ...
                    <table class="table table-row-dashed table-row-gray-300 align-middle gs-0 gy-4 m-0">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="text-end">
                                    <form class="form-check form-switch d-flex justify-content-end" title="Some info about it's function!" action="{{ route('admin.service.change-status', $service->id) }}" method="POST">
                                        @csrf
                                        @method('PATCH')
