                        ...
                        <tbody>
                            ...
                            <tbody class="label">
                                <tr>
                                    ...
                                    <td class="text-end">
                                        <form class="form-check form-switch d-flex justify-content-end" title="Toggle status" action="{{ route('admin.page.change-status', $page->id) }}" method="POST">
                                            @csrf
                                            @method('PATCH')
                                    ...
                                    <td class="text-end">
                                        <a href="#" class="btn btn-icon btn-bg-light btn-active-color-primary btn-sm me-1"
                                            title="Edit page details" data-bs-toggle="modal"
                                        ...
                                        <a href="#{{ $page->id }}" class="btn btn-icon btn-bg-light btn-active-color-primary btn-sm me-1"
                                            title="View Section" data-toggle="toggle">
