    ...
    <div id="kt_app_toolbar" class="app-toolbar  py-3 py-lg-6 ">
        ...
        <div id="kt_app_toolbar_container" class="app-container container-xxl d-flex flex-stack">
            ...
            <div class="d-flex align-items-center gap-2 gap-lg-3">
                ...
                <a href="#" class="btn btn-sm fw-bold btn-info" data-bs-toggle="modal" data-bs-target="#modal_new_banner">Add Feedback</a>
                    ...
                    <table class="table table-row-dashed table-row-gray-300 align-middle gs-0 gy-4 m-0">
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td>
                                    <div class="d-flex align-items-center">
                                        ...
                                        <div class="d-flex justify-content-start flex-column" data-toggle="toggle">
                                            ...
                                            <span class="text-muted w-300px fw-semibold text-muted d-block fs-7 text-truncate">{{ $feedback->feedback }}</span>
                                        </div>
                                        <!--end::Name-->
                                    </div>
                                </td>
                                ...
                                <td class="text-end">
                                    <form class="form-check form-switch form-check-custom form-check-success form-check-solid d-flex justify-content-end" title="Some info about it's function!" action="{{ route('admin.feedback.change-status', $feedback->id) }}" method="POST">
                                        @csrf
                                        @method('PATCH')
                                ...
                                <td class="text-end">
                                    <a href="#" class="btn btn-icon btn-bg-light btn-active-color-primary btn-sm me-1"
                                        ...
                                        data-bs-target="#modal_update_banner" onclick="inputPageData({{ json_encode($feedback) }}, '{{ asset('storage') }}')">
                ...
                <div class="modal-body scroll-y px-10 px-lg-15 pt-0 pb-15">
                    ...
                    <form  class="form fv-plugins-bootstrap5 fv-plugins-framework"
                        ...
                        <div class="d-flex flex-column mb-8 fv-row fv-plugins-icon-container">
                            ...
                            <input type="text" class="form-control form-control-solid" placeholder="Best Website Ever" name="name" required>
