                    ...
                    <table class="table table-row-dashed table-row-gray-300 align-middle gs-0 gy-4 m-0">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="text-end">
                                    <form class="form-check form-switch d-flex justify-content-end" title="Some info about it's function!" action="{{ route('admin.banner.change-status', $banner->id) }}" method="POST">
                                        @csrf
                                        @method('PATCH')
                ...
                <div class="modal-body scroll-y px-10 px-lg-15 pt-0 pb-15">
                    ...
                    <form id="modal_new_targ_banner" class="form fv-plugins-bootstrap5 fv-plugins-framework"
                        ...
                        <div class="d-flex flex-column mb-8 fv-row fv-plugins-icon-container">
                            ...
                            <input type="text" id="editTitleInput" class="form-control form-control-solid" placeholder="E.g Home | Our Website" name="title" required>
                            <div class="fv-plugins-message-container invalid-feedback"></div>
                        </div>
                        <!--end::Input group-->
