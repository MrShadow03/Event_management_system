        ...
        <div id="kt_app_toolbar_container" class="app-container container-fluid d-flex flex-stack">
            ...
            <div class="page-title d-flex flex-column justify-content-center flex-wrap me-3 ">
                ...
                <ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-0 pt-1">
                    ...
                    <!--begin::Item-->
                    <li class="breadcrumb-item text-muted">{{ $workforce->name }}</li>
                    <!--end::Item-->
                </ul>
                <!--end::Breadcrumb-->
            </div>
            ...
            <div class="d-flex align-items-center gap-2 gap-lg-3">
                ...
                <a href="{{ route('admin.workforces') }}" class="btn btn-sm fw-bold btn-primary">All Employees </a>
            ...
            <div class="card card-flush">
                ...
                <div class="card-body pt-5">
                    ...
                    <div class="d-flex flex-column gap-5">
                        ...
                        <!--begin::Contact group-->
                        <div class="d-flex flex-stack">
                            <a href="getting-started.html" class="fs-6 fw-bold text-gray-800 text-hover-primary ">Tier 1
                                Member</a>
                    ...
                    <a href="add-contact.html" class="btn btn-primary w-100">
                        <i class="ki-duotone ki-badge fs-2"><span class="path1"></span><span
                                ...
                                class="path5"></span></i> Add new contact
                    </a>
                    <!--end::Add new contact-->
                </div>
                <!--end::Card body-->
                    ...
                    <div class="scroll-y me-n5 pe-5 h-300px h-xl-auto" data-kt-scroll="true"
                        ...
                        <div class="d-flex flex-stack py-4">
                            ...
                            <div class="d-flex align-items-center">
                                ...
                                <div class="symbol  symbol-40px symbol-circle "><img alt="Pic"
                                        src="{{ asset('assets/admin/assets/media/avatars/300-6.jpg') }}"></div>
                                <!--end::Avatar-->
                                <!--begin::Details-->
                                <div class="ms-4">
                                    <a href="{{ route('admin.workforce.user', 65) }}"
                        ...
                        <div class="d-flex flex-stack py-4">
                            ...
                            <div class="d-flex align-items-center">
                                <!--begin::Avatar-->
                                <div class="symbol  symbol-40px symbol-circle "><img alt="Pic"
                                        src="{{ asset('assets/admin/assets/media/avatars/300-5.jpg') }}"></div>
                                <!--end::Avatar-->
                                <!--begin::Details-->
                                <div class="ms-4">
                                    <a href="{{ route('admin.workforce.user', 65) }}"
                        ...
                        <div class="d-flex flex-stack py-4">
                            ...
                            <div class="d-flex align-items-center">
                                <!--begin::Avatar-->
                                <div class="symbol  symbol-40px symbol-circle "><img alt="Pic"
                                        src="{{ asset('assets/admin/assets/media/avatars/300-25.jpg') }}">
                                    <div
                        ...
                        <div class="d-flex flex-stack py-4">
                            ...
                            <div class="d-flex align-items-center">
                                <!--begin::Avatar-->
                                <div class="symbol  symbol-40px symbol-circle "><img alt="Pic"
                                        src="{{ asset('assets/admin/assets/media/avatars/300-9.jpg') }}"></div>
                                <!--end::Avatar-->
                                <!--begin::Details-->
                                <div class="ms-4">
                                    <a href="{{ route('admin.workforce.user', 65) }}"
                        ...
                        <div class="d-flex flex-stack py-4">
                            ...
                            <div class="d-flex align-items-center">
                                <!--begin::Avatar-->
                                <div class="symbol  symbol-40px symbol-circle "><img alt="Pic"
                                        src="{{ asset('assets/admin/assets/media/avatars/300-23.jpg') }}"></div>
                                <!--end::Avatar-->
                                <!--begin::Details-->
                                <div class="ms-4">
                                    <a href="{{ route('admin.workforce.user', 65) }}"
                        ...
                        <div class="d-flex flex-stack py-4">
                            ...
                            <div class="d-flex align-items-center">
                                <!--begin::Avatar-->
                                <div class="symbol  symbol-40px symbol-circle "><img alt="Pic"
                                        src="{{ asset('assets/admin/assets/media/avatars/300-12.jpg') }}"></div>
                                <!--end::Avatar-->
                                <!--begin::Details-->
                                <div class="ms-4">
                                    <a href="{{ route('admin.workforce.user', 65) }}"
                        ...
                        <div class="d-flex flex-stack py-4">
                            ...
                            <div class="d-flex align-items-center">
                                <!--begin::Avatar-->
                                <div class="symbol  symbol-40px symbol-circle "><img alt="Pic"
                                        src="{{ asset('assets/admin/assets/media/avatars/300-13.jpg') }}">
                                    <div
                                        class="symbol-badge bg-success start-100 top-100 border-4 h-15px w-15px ms-n2 mt-n2">
                                    </div>
                                </div><!--end::Avatar-->
                        ...
                        <div class="d-flex flex-stack py-4">
                            ...
                            <div class="d-flex align-items-center">
                                <!--begin::Avatar-->
                                <div class="symbol  symbol-40px symbol-circle "><img alt="Pic"
                                        src="{{ asset('assets/admin/assets/media/avatars/300-21.jpg') }}">
                                    <div
                                        class="symbol-badge bg-success start-100 top-100 border-4 h-15px w-15px ms-n2 mt-n2">
                                    </div>
                                </div><!--end::Avatar-->
        ...
        <div class="col-xl-9">
            ...
            <div class="card card-flush h-lg-100" id="kt_contacts_main">
                ...
                <div class="card-header pt-7" id="kt_chat_contacts_header">
                    <!--begin::Card title-->
                    <div class="card-title">
                        <i class="ki-duotone ki-badge fs-1 me-2"><span class="path1"></span><span
                                class="path2"></span><span class="path3"></span><span class="path4"></span><span
                                class="path5"></span></i>
                    ...
                    <div class="card-toolbar gap-3">
                        ...
                        <button class="btn btn-sm btn-light btn-active-light-primary" data-kt-drawer-show="true"
                            ...
                            <i class="ki-duotone ki-message-text-2 fs-2"><span class="path1"></span><span
                                    class="path2"></span><span class="path3"></span></i> Chat
                        </button>
                        <!--end::Chat-->
                        ...
                        <a href="../inbox/reply.html" class="btn btn-sm btn-light btn-active-light-primary">
                            <i class="ki-duotone ki-messages fs-2"><span class="path1"></span><span
                                    ...
                                    class="path4"></span><span class="path5"></span></i> Message
                        </a>
                        <!--end::Chat-->
                        ...
                        <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-semibold fs-7 w-125px py-4"
                            ...
                            <div class="menu-item px-3">
                                <a href="#" class="menu-link px-3" id="kt_contact_delete"
                                    data-kt-redirect="getting-started.html">
                                    Delete
                                </a>
                            </div>
                            <!--end::Menu item-->
                ...
                <div class="card-body pt-5">
                    ...
                    <div class="d-flex gap-7 align-items-center">
                        ...
                        <div class="symbol symbol-circle symbol-100px">
                            <img src="{{ asset('assets/admin/assets/media/avatars/300-6.jpg') }}" alt="image">
                        </div>
                        <!--end::Avatar-->
                        ...
                        <div class="d-flex flex-column gap-2">
                            ...
                            <div class="d-flex align-items-center gap-2">
                                <i class="ki-duotone ki-phone fs-2"><span class="path1"></span><span
                                        class="path2"></span></i> <a href="#"
                                    class="text-muted text-hover-primary">+6141 234 567</a>
                            </div>
                            <!--end::Phone-->
                        </div>
                        <!--end::Contact details-->
                    ...
                    <ul
                        ...
                        <li class="nav-item">
                            <a class="nav-link text-active-primary d-flex align-items-center pb-4"
                                ...
                                <i class="ki-duotone ki-save-2 fs-4 me-1"><span class="path1"></span><span
                                        class="path2"></span></i> Activity
                            </a>
                        </li>
                        <!--end:::Tab item-->
                    </ul>
                            ...
                            <div class="timeline-label">
                                ...
                                <div class="timeline-item">
                                    ...
                                    <div class="timeline-badge">
                                        <i class="ki-duotone ki-abstract-8 text-warning fs-1"><span
                                ...
                                <div class="timeline-item">
                                    ...
                                    <!--begin::Badge-->
                                    <div class="timeline-badge">
                                        <i class="ki-duotone ki-abstract-8 text-success fs-1"><span
                                                class="path1"></span><span class="path2"></span></i>
                                    </div>
                                    <!--end::Badge-->
                                ...
                                <div class="timeline-item">
                                    ...
                                    <!--begin::Badge-->
                                    <div class="timeline-badge">
                                        <i class="ki-duotone ki-abstract-8 text-danger fs-1"><span
                                                class="path1"></span><span class="path2"></span></i>
                                    </div>
                                    <!--end::Badge-->
                                ...
                                <div class="timeline-item">
                                    ...
                                    <!--begin::Badge-->
                                    <div class="timeline-badge">
                                        <i class="ki-duotone ki-abstract-8 text-primary fs-1"><span
                                                class="path1"></span><span class="path2"></span></i>
                                    </div>
                                    <!--end::Badge-->
...
@section('exclusive_scripts')
    ...
    <script src="{{ asset('assets/admin/assets/js/custom/apps/contacts/view-contact.js') }}"></script>
@endsection
