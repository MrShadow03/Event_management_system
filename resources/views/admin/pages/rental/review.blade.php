                        ...
                        <div class="d-flex flex-column gap-10">
                            ...
                            <div id="product_table_wrapper" class="">
                                <div class="table-responsive">
                                    <table class="table">
                                        ...
                                        <tfoot id="product_footer">
                                            ...
                                            <tr>
                                                <td colspan="3" class="text-end">Pay from Deposit(TK)</td>
                                ...
                                <div class="d-flex justify-content-end mt-3">
                                    ...
                                    <!--begin::Button-->
                                    <a href="javascript:void(0);" class="btn btn-danger me-5" id="declineButton">
    ...
    <script>
        ...
        document.addEventListener('DOMContentLoaded', function () {
            ...
            declineButton.addEventListener('click', function () {
                ...
                // Change the form's action to the "Decline" route
                approvalForm.action = "{{ route('admin.rentals.review.decline') }}";
                ...
                Swal.fire({
                    ...
                    customClass: {
                        confirmButton: 'btn btn-sm btn-danger my-0' // Add a custom class
                    }
