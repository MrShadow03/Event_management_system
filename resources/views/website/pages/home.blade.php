...
@section('main-content')
    ...
    @endsection
    <div class="aro_img"></div>
    <div class="custom_title1">
        <h2>EVENT MANAGEMENT<span class="border"></span></h2>
    ...
    <div class="event">
       <div class="eventCard_md">
            <div class="img_area">
                <img src="https://maaevent.com/wp-content/uploads/2023/07/Mushira-Fahad-1-614x800.jpg" alt="">
            </div>
    ...
    <div class="catering">
        ...
        <div class="catering_slider right_side">
            ...
            <div class="custom_title2">
                ...
                <p>Looking for the perfect venue for your next event? Let our event management company take care of it! With our expertise &amp; extensive network of venues, we’ll help you find the ideal space to bring your event to life. Book your venue with us today &amp; get ready for an experience!</p>
                <a class="btn_black" href="#">VIEW</a>
            </div>
        </div>
    </div>
    ...
    <div class="followUs">
        ...
        <div class="social_btn_lg">
            <a class="btn_lg Facebook" href="#">Facebook Review</a>
            <a class="btn_lg google" href="#">Google Review</a>
        </div>
    </div>
@endsection
