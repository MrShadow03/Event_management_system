...
<div class="catering_sec">
    ...
    <div class="bibidho_items_sec">
        ...
        <div class="card_items_list">
            <img src="{{ asset('./assets/website/assets/img/Dessert-01-maaevent.jpg') }}" alt="">
            <ul class="card_text">
            ...
            <img src="{{ asset('./assets/website/assets/img/Dessert-02-maaevent.jpg') }}" alt="">
        </div>
    </div>
    <div class="catering_sec_text">
    ...
    <div class="driver_items_sec">
        <div class="card_items_list">
            ...
            <img src="{{ asset('./assets/website/assets/img/Morog-Pollao.jpg') }}" alt="">
        </div>
    </div>
</div>
@endsection
